declare namespace Vimeo {
  ...
  interface InvalidTrackLanguageError extends Error {
    name: 'InvalidTrackLanguageError';
    message: string;
    method: string;
  }
  interface InvalidTrackError extends Error {
  ...
  interface ContrastError extends Error {
    name: 'ContrastError';
    message: string;
    method: string;
  }
  interface InvalidCuePoint extends Error {
